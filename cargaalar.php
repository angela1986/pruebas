...
<script type="text/javascript" src="jquery.js">
    ...
    <script>
            $(document).ready(function(){
                $("#cargaalarsol").click(function(evento){
                    evento.preventDefault();
                    $("#destino8").load("cargaalarsol.php", {valor: $("").val() , valor2: $("").val()});
                });
            })
        </script>
	<style type="text/css">
...
<h1><Center>CARGA ALAR</center></h1>
<CENTER> <IMG SRC="images/cargaalar.JPG" border="0" height="250" width="500"></CENTER>
<h4>
...
<p> En la mayoría de los diseños de aviones, la  carga alar es determinada por consideraciones de Vstall la distancia de aterrizaje. Sin embargo, W / S también desempeña un papel en el máximo de velocidad del avi &oacuten. La Vmx aumenta como W / S aumenta. Entonces tenemos que: </p>


<div id="destino8">
   
                </div>
<div><center><input type="submit" style = "width : 150px ; height :30px " id="cargaalarsol" value="cargaalarsol"></center></div>
