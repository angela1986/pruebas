...
<h3><Center>
 <? 
    ...
    $query = @mysql_query("SELECT * FROM usuario WHERE nick='". $_POST['nick'] ."' and Clave = '". $_POST['Clave'] ."'");
    
    // $query = @mysql_query('SELECT * FROM usuario WHERE nombre="'.mysql_real_escape_string($nombre).'".AND Clave="'.mysql_real_escape_string($Clave)."');
...
// Si entramos es que todo se ha realizado correctamente 
        ...
        //} else { 
         ...
         // echo "Bienvenido  ", $_POST['nick'] ," "," ", "  inicia a diseñar."; 
